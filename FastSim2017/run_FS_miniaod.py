...
# with command line options: step1 --fileout file:testFSminiAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --fast --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v15 --step PAT --nThreads 4 --scenario pp --era Run2_2017_FastSim,run2_miniAOD_94XFall17 --python_filename run_FS_miniaod.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1152
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('PAT',eras.Run2_2017_FastSim,eras.run2_miniAOD_94XFall17,eras.fastSim)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:testFS_2.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:testFSminiAOD.root'),
